...
func solution(_ S : String) -> String {
    ...
    let str: String = S.replacingOccurrences(of: " ", with: "").replacingOccurrences(of: "-", with: "")
    var result = ""
    var count = -2
    ...
    var arrResult = Array(result)
    let secondLastElement = arrResult[arrResult.count-2]
    
    if secondLastElement == "-" {
        
        arrResult[arrResult.count-2] = arrResult[arrResult.count-3]
        arrResult[arrResult.count-3] = secondLastElement
    }
